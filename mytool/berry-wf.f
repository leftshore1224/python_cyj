...
! last update and bug fixes : 2016. Jun. 29. by H.-J. Kim 
...
!    &         ,I4,'th-K')
        ...
        write(6,704)ik,rfield,detLOOP,ikk(:),wkk(:,ilp),
     &              (wkk(:,1)+wkk(:,3))/2.,itr_sum
...
!     coeff=coeff/sqrt(real(npl(iilp)))
...
!!$*  subroutine for finding k-point index for certain wk
     ...
     &                     i_half_klist,i_trim_klist,nhf)
      ...
      implicit real*8(a-h,o-z)
      dimension wkk(3,5),ikk(5),isgg(2,5),wklist(3,nk),itr(5)
...
!!$*  subroutine for reading basic information
     ...
     &-kp 1"
      ...
      write(6,*)" ex-MPI)mpif90 -DMPI_USE -fpp -assume byterecl 
     &-o berry berry.f"
