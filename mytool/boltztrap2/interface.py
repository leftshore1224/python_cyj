...
def parse_plot(args):
	...
	## ssrokyz start
        if args.axvline:
            plt.axvline(args.axvline, ls=':', c='k', label='x={}'.format(args.axvline))
...
def parse_arguments():
    ...
    plot_parser.add_argument(
        ...
        "--Hartree",
        action="store_true",
        help="If provided, energy unit is set to be Hartree. [Default: eV]",
        )
    plot_parser.add_argument(
        "-x",
        "--axvline",
        type=float,
        default=None,
        help="Draw a vertical dashed line at provided x value. [Default: no line]",
        )
    plot_parser.add_argument(
        "-q",
        "--xmin",
        type=float,
        default=None,
        help="Minimum x limit of the plot.",
        )
    plot_parser.add_argument(
        "-w",
        "--xmax",
        type=float,
        default=None,
        help="Maximum x limit of the plot.",
        )
    plot_parser.add_argument(
        "-e",
        "--ymin",
        type=float,
        default=None,
        help="Minimum y limit of the plot.",
        )
    plot_parser.add_argument(
        "-r",
        "--ymax",
        type=float,
        default=None,
        help="Maximum y limit of the plot.",
        )
    ## ssrokyz end
