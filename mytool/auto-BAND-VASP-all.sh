...
SYS="C16 conventional unit cell 1"
N_Lines=6           # Number of symmetry lines !!!! Check!!! IMPORTANT !!!!
E_Fermi=5.7863      # grep fermi OUTCAR (total energy calculation)
...
### How many symmetry points? : number of lines = LINE#   !!!! Check !!! IMPORTANT !!!!
                       KP_1=" 0.250000000   0.250000000   0.000000000 ";KP_1_name="T";KPS_init='T'
LINE1=" output band " ;KP_2=" 0.250000000   0.250000000   0.250000000 ";KP_2_name="W";KPS_2='W'
LINE2=" output band " ;KP_3=" 0.000000000   0.250000000   0.250000000 ";KP_3_name="R";KPS_3='R'
LINE3=" output band " ;KP_4=" 0.000000000   0.000000000   0.000000000 ";KP_4_name="G";KPS_4='{/Symbol \G}'
LINE4=" output band " ;KP_5=" 0.500000000   0.000000000   0.000000000 ";KP_5_name="X";KPS_5='X'
LINE5=" output band " ;KP_6=" 0.250000000   0.000000000   0.250000000 ";KP_6_name="S";KPS_6='S'
LINE6=" output band " ;KP_7=" 0.000000000   0.000000000   0.000000000 ";KP_7_name="G";KPS_end='{/Symbol \G}'
...
set xtics ("$KPS_init" $Xinit, "$KPS_2" $K_2_point, "$KPS_3" $K_3_point, "$KPS_4" $K_4_point, "$KPS_5" $K_5_point, "$KPS_6" $K_6_point,  "$KPS_end" $Xend) font "Helvetical,24" offset 0,0.2
